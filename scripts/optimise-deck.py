...
def flatten(path):
    ...
    output.set_metadata({"title": "AI Engineer Career Talk", "author": "Tushar Gaurav", "subject": "AI engineering careers and Orangewood Labs", "creator": "Flattened presentation export"})
